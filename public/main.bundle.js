...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>MEAN Auth App</h1>\n  <p class=\"lead\">Welcome to the App, Go a head and roam around.</p>\n  <div>\n    <a [routerLink]=\"['/register']\" class=\"btn btn-primary\">Register</a>\n    <a [routerLink]=\"['/login']\" class=\"btn btn-default\">Login</a>\n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-md-4\">\n    <h3>Express Server</h3>\n    <p>Backend API consists of Node.js Express server.</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Angular 4</h3>\n    <p>Front-end is built with the popular Angular 4 SPA Framework by Google &reg;</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Authentication</h3>\n    <p>Based on JSON Web Tokens module for token based Auth.</p>\n  </div>\n</div>"
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.loginUser = function () {
        ...
        this.auth.authenticateUser(user)
            ...
            if (data.success) {
                _this.auth.storeUser(data.token, data.user);
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.registerUser = function () {
        ...
        this.auth.registerUser(user)
            .subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('Registration Successful, You can login now.', {
                    cssClass: 'alert-success',
                    timeout: 3000
                });
                _this.router.navigate(['login']);
...
var AuthService = (function () {
    ...
    AuthService.prototype.registerUser = function (user) {
        ...
        return this.$http
            .post('http://localhost:3000/users/register', user, { headers: headers }).map(function (res) { return res.json(); });
    };
    AuthService.prototype.authenticateUser = function (user) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.$http
            .post('http://localhost:3000/users/authenticate', user, { headers: headers }).map(function (res) { return res.json(); });
    };
    AuthService.prototype.getProfile = function () {
        ...
        return this.$http
            .get('http://localhost:3000/users/profile', { headers: headers }).map(function (res) { return res.json(); });
    };
